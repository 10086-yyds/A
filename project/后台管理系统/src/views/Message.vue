      ...
      <div class="chat-area">
        ...
        <div v-if="selectedUser" class="messages-container" ref="messagesContainer">
          <div class="messages-list">
            <div
              v-for="message in getChatMessages(selectedUser.id)"
              :key="message.id"
              class="message-item"
              :class="{
            ...
            >
              ...
              <div class="message-content">
                ...
                <div class="message-status" v-if="message.sender.type === 'admin'">
                  ...
                  <el-icon v-else-if="message.status === 'delivered'"><Check /></el-icon>
                  <el-icon v-else-if="message.status === 'read'"><Check /></el-icon>
                </div>
              </div>
            </div>
          </div>
