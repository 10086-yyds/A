  ...
  <div class="doctor-page">
    ...
    <div class="action-bar">
      <div class="left-actions">
        <el-button v-permission="'doctor_add'" type="primary" @click="showAddDialog = true" :icon="Plus">
          添加医生
        </el-button>
        <el-button v-permission="'doctor_import'" type="success" @click="handleImport" :icon="Upload">
          批量导入
        </el-button>
      </div>

      <div class="right-actions">
        <el-input v-model="searchKeyword" placeholder="搜索医生姓名、科室或职称" style="width: 300px" clearable
          @input="handleSearch">
          <template #prefix>
            <el-icon>
              <Search />
        ...
        <el-button v-permission="'doctor_export'" type="info" @click="handleExport" :icon="Download">
          导出数据
        </el-button>
      </div>
    </div>
    ...
    <el-table :data="filteredDoctors" v-loading="loading" style="width: 100%" border stripe>
      ...
      <el-table-column label="操作" width="200" fixed="right">
        <template #default="{ row }">
          <el-button v-permission="'doctor_view'" type="primary" size="small" @click="handleView(row)" :icon="View">
            查看
          </el-button>
          <el-button v-permission="'doctor_edit'" type="warning" size="small" @click="handleEdit(row)" :icon="Edit">
            编辑
          </el-button>
          <el-button v-permission="'doctor_delete'" type="danger" size="small" @click="handleDelete(row)"
            :icon="Delete">
            删除
          </el-button>
        </template>
    ...
    <!-- 添加/编辑医生对话框 -->
    <el-dialog v-model="showAddDialog" :title="isEdit ? '编辑医生' : '添加医生'" width="600px" :close-on-click-modal="false">
