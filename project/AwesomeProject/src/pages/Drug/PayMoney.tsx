...
const PayMoney = ({ navigation, route }: any) => {
    ...
    const handleNumberPress = (num: string) => {
        if (password.length < 6 && !isLoading) {
            ...
            console.log('条件不满足:', {
                ...
                isLoading,
                canInput: password.length < 6 && !isLoading
            });
        }
    };
    ...
    const handleConfirmPasswordWithPassword = async (inputPassword: string) => {
        console.log('handleConfirmPasswordWithPassword 被调用，密码:', inputPassword);
        ...
        if (inputPassword.length === 6) {
            ...
            try {
                ...
                try {
                    ...
                    if (SavedItems && SavedItems !== '[]') {
                        ...
                        const response = await fetch('http://172.20.10.3:3000/Zjf/PayMoney', {
                            method: 'POST',
                            headers: {
            ...
            console.log('密码长度不正确:', inputPassword.length);
        }
    };
